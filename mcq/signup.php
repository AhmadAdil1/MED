...
<body onload="get_college_options()">
...
<div class="row">
    ...
    <form action="signup.php" method="post">
     ...
     <div class="alert alert-danger">
      ...
      <input type="email" name="email" value="<?php echo $email; ?>" placeholder="Write your email address" class="form-control form-control-lg">
      </div>
