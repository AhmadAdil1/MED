...
include "cnns.php";
        ...
        $block = $_REQUEST['block_options'];
        $subject = $_REQUEST['subject_options'];
        ...
        $right_ans_cor = "";    
            ...
            if(mysqli_query($conn, $sql)){
                echo "<h3>You have uploaded a question successfully, Thanks!</h3> <META HTTP-EQUIV='Refresh' Content='3; URL=index.php'>";
                // echo $right_ans;
